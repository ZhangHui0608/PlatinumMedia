...
public class CallbackTypes {
    ...
    public static final int CALLBACK_EVENT_ON_SET_MEDIA_DURATION = 1011;
    public static final int CALLBACK_EVENT_ON_SET_MEDIA_POSITION = 1012;
    public static final int CALLBACK_EVENT_ON_SET_MEDIA_PLAYING_STATE = 1013;
}
